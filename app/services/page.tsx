...
export default function Page() {
    return (
        <Navbar>
            <section
                id="hero"
                className="w-[calc(100%-16px)] mx-auto my-14 h-[300px] rounded-lg bg-cover bg-center flex items-center justify-start pl-8 sm:pl-64 sm:h-[400px] sm:rounded-2xl sm:w-[calc(100%-150px)]"
                style={{
